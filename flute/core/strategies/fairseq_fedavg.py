...
class FairseqFedAvg(BaseStrategy):
    '''Federated Averaging'''
    ...
    def generate_client_payload(self, fairseq_trainer, num_samples):
        ...
        if self.stats_on_smooth_grad:
            fairseq_trainer.reset_gradient_power()
            fairseq_trainer.estimate_sufficient_stats()
        ...
        payload['gradients'] = [p.grad.to(torch.device('cpu')) for p in fairseq_trainer.model.parameters()]
