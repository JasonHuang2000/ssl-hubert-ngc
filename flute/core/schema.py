...

{
    ...
    'fl_config':{
            ...
            'allow_unknown': True,
            'schema': {
                'total_clients': {'required': True, 'type':'integer'},
                'fairseq_config_dir': {'required': True, 'type':'string'},
                'config_name': {'required': True, 'type':'string'},
                'epoch_per_update': {'required': True, 'type':'integer'},
                }
    },
