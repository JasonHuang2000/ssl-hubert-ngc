...
from .fairseq_trainer import Trainer as fs_trainer
...
def fairseq_train(
    ...
    for i, samples in enumerate(progress):
        ...
        with metrics.aggregate("train_inner"), torch.autograd.profiler.record_function(
            ...
            log_output, loss, num_sample = trainer.train_step(samples)
            total_loss += loss
        ...
        #     # fl_iteration=1,
        # )
        # print(valid_losses, should_stop)
...
def fairseq_validate_and_save(
    ...
    do_save = (
        (end_of_epoch and fl_iteration % cfg.checkpoint.save_interval == 0)
        or should_stop
        or (
    ...
    # Validate
    valid_losses = [None]
    valid_losses = fairseq_validate(cfg, trainer, task, epoch_itr, valid_subsets, fl_iteration)
...
def fairseq_validate(
    ...
    trainer.begin_valid_epoch(fl_iteration)
    valid_losses = []
